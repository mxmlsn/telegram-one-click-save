// AI Prompts for bot analysis
// AI_PROMPT_IMAGE and AI_PROMPT_LINK are shared with the Chrome extension (src/shared/prompts.js)
// but duplicated here since this is a separate Cloudflare Workers deploy.
// AI_PROMPT_PDF, AI_PROMPT_TRANSCRIBE, AI_PROMPT_AUDIO are bot-specific.
...
export const AI_PROMPT_PDF = `Analyze this PDF document and return ONLY valid JSON, no other text:
{
  "content_type": "pdf",
  "content_type_secondary": null,
  "title": "",
...
export const AI_PROMPT_TRANSCRIBE = `Transcribe this audio message word-for-word. Return ONLY the transcript text, nothing else. If the audio contains no speech or is unintelligible, return an empty string. Do not add any commentary, timestamps, or formatting — just the raw spoken words.`;

export const AI_PROMPT_AUDIO = `Analyze this audio track cover art image and return ONLY valid JSON, no other text:
{
  "color_subject": null,
  "color_palette": null,
  "color_top3": [],
